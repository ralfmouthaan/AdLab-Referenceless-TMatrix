...
Public MustInherit Class clsCamera16
...
#Region "Image Acquisition"
    ...
    Public MustOverride Function GetIntegerImage(Optional ByVal Frames As Integer = -1) As UInt16(,)
    ...
    Public Function GetDoubleImage() As Double(,)
        ...
        Dim Img(,) As UInt16 = GetIntegerImage()
        TypeConversions.UInt16ToDouble(Img, RetVal)
        Return RetVal
...
#Region "Off-axis holography routines"
    ...
    Public Function GetOffAxisCroppedImage() As UInt16(,)
    ...
    Public Function GetOffAxisFFTImage() As Numerics.Complex(,)
        ...
        Dim Img(,) As UInt16 = GetOffAxisCroppedImage()
    ...
    End Function
    Public Function CalculateOffAxisComplexImage(ByVal Img(,) As UInt16) As Numerics.Complex(,)
