...
Namespace ImageProcessing
    Module modImageProcessing
        ...
        End Sub
        Public Sub Crop(ByRef Img(,) As UInt16, ByVal Viewport As Rectangle)

            Dim Input(Img.GetLength(0) - 1, Img.GetLength(1) - 1) As UInt16
            Dim Output(Viewport.Width - 1, Viewport.Height - 1) As UInt16
        ...
        End Sub
        Public Sub Minimum(ByRef Img(,) As Integer, ByRef RetVal As Integer)

            RetVal = Integer.MaxValue
            For i = 0 To UBound(Img, 1)
                For j = 0 To UBound(Img, 2)
        ...
        End Sub
        Public Sub Minimum(ByRef Img(,) As Numerics.Complex, ByRef RetVal As Double)
        ...
        End Sub
        Public Sub Maximum(ByRef Img(,) As UInt16, ByRef RetVal As UInt16)
